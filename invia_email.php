...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  $immagine = "percorso/immagine.jpg"; // Percorso dell'immagine
  $descrizione = $_POST["descrizione"]; // Descrizione inserita dal cliente

  // Invio dell'email
  $to = "info@graficaindipendente.com"; // Indirizzo email del destinatario
  $subject = "Responso bozzetto";
  $message = $descrizione;
  $headers = "From: bozza@graficaindipendente.com" . "\r\n" .
             "Reply-To: no_reply@graficaindipendente.com" . "\r\n";
