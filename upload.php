<?php
$targetDirectory = "percorso/"; // Specifica qui la cartella di destinazione del server
...
// Se tutto è ok, carica il file e ridimensiona l'immagine
    ...
    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $targetFile)) {
        ...
        echo "Il file " . basename($_FILES["fileToUpload"]["name"]) . " è stato caricato con successo come immagine.jpg.";
    } else {
